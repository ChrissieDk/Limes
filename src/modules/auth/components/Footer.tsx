...
const Footer = memo(function Footer() {
  ...
  const socials = [
    {
      label: "Social 1",
      src: `${base}images/social1.png`,
      href: "#",
      enabled: false,
    },
    {
      label: "Social 2",
      src: `${base}images/social2.png`,
      href: "#",
      enabled: false,
    },
    {
      label: "Social 3",
      src: `${base}images/social3.png`,
      href: "#",
      enabled: false,
    },
    {
      label: "Instagram",
      src: `${base}images/social4.png`,
      href: "https://www.instagram.com/limes.network/",
      enabled: true,
    },
  ] as const;
  ...
  return (
    <footer className="mx-auto max-w-6xl px-6 pt-16 pb-10">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
        <div>
          <img
            src={`${base}images/limes-mobile_horizontal.svg`}
            alt="Limes"
            className="h-10"
          />
          ...
          <div className="mt-4 space-y-1 text-sm text-neutral-400 font-manrope">
            ...
            <p>
              ...
              <a
                href="mailto:support@simpal.co.za"
                className="hover:text-white transition-colors"
              >
        ...
        <div className="md:justify-self-center">
          <div className="font-grotesque text-sm text-neutral-400 font-semibold">
            Quick Links
          </div>
