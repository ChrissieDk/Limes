...
export default function WhyChoose() {
  ...
  type AllocationKey = 'data' | 'airtime' | 'sms' | 'whatsapp'
  ...
  const lineItems = [
    {
      ...
      label: 'Mobile data',
      iconSrc: `${import.meta.env.BASE_URL}images/data.png`,
      bgClass: 'bg-lime-300',
      step: 5,
    },
    {
      ...
      label: 'Airtime',
      iconSrc: `${import.meta.env.BASE_URL}images/plan_logo.png`,
      bgClass: 'bg-[#CDA7FC]',
      step: 5,
    },
    {
      ...
      label: 'SMS',
      iconSrc: `${import.meta.env.BASE_URL}images/sms.png`,
      bgClass: 'bg-[#5BA0FF]',
      step: 5,
    },
    {
  ...
  return (
    <section id="why" className="mx-auto max-w-6xl px-6 pb-24 scroll-mt-24">
      ...
      <div className="mt-10 grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_360px] gap-6 lg:gap-8 items-start">
        {/* Plan tiles */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 lg:gap-2 content-start self-start">
          {lineItems.map((item) => {
            ...
            return (
              <div
                key={item.key}
                className={`rounded-[26px] ${item.bgClass} p-5 shadow-[0_24px_70px_rgba(0,0,0,0.35)] flex flex-col justify-center gap-4 lg:h-[190px]`}
              >
                <div className="flex items-start gap-3">
                  {item.iconSrc ? (
                    <img src={item.iconSrc} alt={item.label} className="h-9 w-9" />
                  ) : (
                    <div className="h-9 w-9 grid place-items-center">
                      <svg className="h-9 w-9 text-neutral-900" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className={`flex items-center gap-2 ${enabled ? '' : 'opacity-70'}`}>
                  <button
                    type="button"
        ...
        {/* Plan total */}
        <div className="rounded-[26px] bg-[#26252C] border border-white/10 p-7 shadow-[0_24px_70px_rgba(0,0,0,0.35)] flex flex-col self-start lg:h-[388px]">
