...
const howTos = [
  {
    id: 'join',
    title: 'How to Join',
    description: 'Get a new Limes SIM or bring your existing number. Two ways in, both refreshingly simple.',
  ...
  },
  {
    id: 'rica',
    title: 'How to RICA',
    description: 'Register your SIM from your couch in about 5 minutes. No store visits, no paperwork shuffle.',
    colour: 'bg-[#5BA0FF]',
    textColour: 'text-neutral-900',
  ...
  },
  {
    ...
    description: 'From ICCID scan to going live. Understand activation polling, delivery status, and the activate button.',
    colour: 'bg-[#ABFF63]',
    textColour: 'text-neutral-900',
  ...
  },
  {
    id: 'top-up',
    title: 'How to Top Up',
    description: 'Running low? Add data, airtime, voice, SMS or WhatsApp bundles in seconds from your dashboard.',
    colour: 'bg-pink-300',
    textColour: 'text-neutral-900',
  ...
  },
  {
    ...
    description: 'Courier timelines, tracking your SIM, and what happens from order to doorstep.',
    colour: 'bg-[#CDA7FC]',
    textColour: 'text-neutral-900',
  ...
  },
  {
    ...
    description: 'Keep your number and switch to Limes. What to expect, timelines, and how we keep you updated.',
    ...
    <div className="min-h-screen bg-neutral-900 text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-10 pb-6">
        <div className="font-manrope flex items-center justify-center text-sm text-neutral-400">
          <span className="size-1.5 rounded-full bg-lime-400 mr-2" /> How To&apos;s
        </div>
        <h1 className="mt-4 font-grotesque font-bold text-center leading-[1.05]">
          <span className="block text-[36px] sm:text-[48px] md:text-[64px]">Never wonder about</span>
          <span className="block text-[36px] sm:text-[48px] md:text-[64px]">a process again</span>
        </h1>
