...
export default function HowToActivate() {
  return (
    <>
        ...
        <div className="min-h-screen bg-neutral-900 text-white">
          ...
          <section className="mx-auto max-w-6xl px-6 pt-10 pb-6">
            <div className="font-manrope flex items-center justify-center text-sm text-neutral-400">
              <span className="size-1.5 rounded-full bg-[#ABFF63] mr-2" /> How
              To&apos;s
            </div>
            ...
            <p className="mt-4 text-center text-neutral-400 text-base md:text-lg font-manrope max-w-2xl mx-auto">
              From order to going live. Understand how activation works, what
              happens behind the scenes, and what you need to do.
            </p>
            ...
            <div className="rounded-[28px] bg-[#26252C] border border-white/10 p-6 md:p-10">
              ...
              <div className="mt-8 flex items-start gap-3">
                ...
                <p className="text-sm text-[#ABFF63] font-manrope">
                  <span className="font-semibold">Heads up:</span> Keep your
                  dashboard open during activation. The status updates
                  automatically and the Activate button will appear as soon as
                  your SIM is ready.
                </p>
              </div>
            </div>
      ...
      <MobilePage title="How to Activate" backTo="/how-to">
        <div className="px-4 pt-4 space-y-6">
          ...
          <div>
            ...
            <p className="mt-2 text-neutral-400 text-sm font-manrope leading-relaxed">
              From order to going live. Understand how activation works and what
              you need to do.
            </p>
          </div>
          ...
          <div className="space-y-3">
            {scenarios.map((s) => (
              <div
                key={s.title}
                className={`rounded-2xl ${s.colour} text-neutral-900 border-2 border-black/60 shadow-[3px_3px_0_0_rgba(0,0,0,0.6)] p-4`}
              >
                <h3 className="font-grotesque font-bold text-lg leading-[1.1]">
                  {s.title}
                </h3>
                <ul className="mt-2 space-y-2 text-sm text-neutral-900/80 font-manrope leading-relaxed">
                  {s.steps.map((step, i) => (
                    <li key={i} className="flex items-start gap-2">
                      <img
                        src={`${import.meta.env.BASE_URL}images/plan_icon_small.svg`}
          ...
          <div className="rounded-2xl bg-[#26252C] border border-white/10 p-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-grotesque font-bold text-xl">
                Activation FAQ
              </h2>
            </div>
            ...
            <div className="mt-4 flex items-start gap-2">
              ...
              <p className="text-xs text-[#ABFF63] font-manrope">
                <span className="font-semibold">Heads up:</span> Keep your
                dashboard open during activation.
              </p>
            </div>
          </div>
