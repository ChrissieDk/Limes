...
export default function Contact() {
  ...
  return (
    <>
        ...
        <div className="min-h-screen text-white bg-[#0E0E12] bg-[radial-gradient(1000px_600px_at_15%_10%,rgba(255,255,255,0.06),transparent_55%),radial-gradient(900px_500px_at_85%_80%,rgba(255,255,255,0.04),transparent_60%)]">
          ...
          <section className="mx-auto max-w-6xl px-6 pt-10 pb-6">
            <div className="font-manrope flex items-center justify-center text-sm text-neutral-400">
              <span className="size-1.5 rounded-full bg-yellow-400 mr-2" />{" "}
              Contact Us
            </div>
            ...
            <div className="mt-10 grid grid-cols-1 lg:grid-cols-[1fr_0.9fr] gap-8 items-stretch">
              {success ? (
                ...
                <form
                  ...
                  className="grid gap-4 content-start lg:self-center"
                >
                  ...
                  {submitError && (
                    <div className="font-manrope text-sm text-red-400">
                      {submitError}
                    </div>
                  )}
                </form>
      ...
      <MobilePage title="Contact Us" backTo="/">
        <div className="px-4 pt-4 pb-8">
          <p className="font-manrope text-sm text-neutral-400 mb-6">
            Ready to partner or learn more? Fill in the form and we&apos;ll get
            back to you.
          </p>
          ...
          {success ? (
            ...
            >
              <div>
                <label className="block font-manrope text-xs text-neutral-400 mb-1">
                  Full name
                </label>
                <input
                  placeholder="Eg. Eric Brick"
