    ...
    >
      <div className="space-y-4">
        <div className="space-y-3 text-sm sm:text-[15px] leading-7 text-neutral-200">
          <p className="font-semibold text-white">1. Application</p>
          <p>
          ...
          <p className="font-semibold text-white">2. Qualifying plans</p>
          <p>2.1 These terms and conditions apply to qualifying plans that we offer (&quot;the plan&quot; or &quot;the plans&quot;).</p>
          <p>2.2 If you have subscribed for a qualifying plan you shall be entitled to the benefits set out in your plan, subject to clauses 3 and 4 below, and upon payment of the applicable monthly fee (&quot;the monthly fee&quot;). Increases to and the method of payment of the monthly fee are provided for in the Mobile Subscriber terms and conditions.</p>
          <p>2.3 The plan shall subsist for as long as you remain a customer of Limes Network, but the plan may be terminated in terms of these terms and conditions and the termination provisions of the Mobile Subscriber terms and conditions.</p>
          <p>2.4 Plan benefits are as specified in your chosen package. All other services provided by us will be charged at the rates provided for in the Limes Network Mobile Subscriber terms and conditions.</p>

          <p className="font-semibold text-white">3. Restrictions</p>
          <p>3.1 The plan must be used for personal or business use. If used for business purposes the additional restrictions in clause 4 apply.</p>
          <p>3.2 Benefits under the plan do not apply to calls made to premium rated numbers or international numbers. These will be charged at the applicable rates prescribed in the Limes Network Mobile Subscriber terms and conditions.</p>
          ...
          <p>3.5 We may require minimum usage (for example, minimum data usage) on a monthly basis. Where such requirements apply, they will be set out in your plan terms.</p>
          <p>3.6 If your usage falls below any minimums specified for your plan, you will be in breach of this policy.</p>
          ...
          <p>3.9 We may require balanced usage (for example, a minimum ratio of incoming to outgoing calls). Where such requirements apply, they will be set out in your plan terms. Incoming calls from us are excluded from such calculations.</p>

          <p className="font-semibold text-white">4. Business users</p>
          ...
          <p className="font-semibold text-white">5. Breach</p>
          <p>5.1 If you are in breach of any of the restrictions identified in section 3:</p>
          <p>5.1.1 You will be migrated to an alternative package which we may offer from time to time, on the terms and conditions that apply to that package, to come into effect from the beginning of the following month; and/or</p>
          <p>5.1.2 You have the option to cancel your subscription with Limes Network.</p>
          <p>5.1.3 We may suspend your plan either temporarily or indefinitely; and/or</p>
          <p>5.1.4 We may preclude you from purchasing the same or similar plans in future.</p>
