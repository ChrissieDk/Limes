    ...
    >
      <div className="space-y-4">
        <div className="font-manrope space-y-3 text-sm sm:text-[15px] leading-7 text-neutral-200">
          ...
          <p className="font-grotesque font-semibold text-white">2. Electronic Communications</p>
          <p>
          ...
          <p className="font-grotesque font-semibold text-white">5. Indemnification</p>
          <p>
          ...
          <p className="font-grotesque font-semibold text-white">6. Variation</p>
          <p>
          ...
          <p className="font-grotesque font-semibold text-white">7. General</p>
          ...
          <p className="font-grotesque font-semibold text-white">8. Payment options</p>
          ...
          <p className="font-grotesque font-semibold text-white">9. Monitoring</p>
          <p>
          ...
          <p className="font-grotesque font-semibold text-white">10. Customer and credit card and security policy</p>
          <p>
          ...
          <p className="font-grotesque font-semibold text-white">11. Contact details</p>
