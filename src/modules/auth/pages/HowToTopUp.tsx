...
export default function HowToTopUp() {
  return (
    <>
        ...
        <div className="min-h-screen bg-neutral-900 text-white">
          ...
          <section className="mx-auto max-w-6xl px-6 pt-10 pb-6">
            <div className="font-manrope flex items-center justify-center text-sm text-neutral-400">
              <span className="size-1.5 rounded-full bg-pink-300 mr-2" /> How
              To&apos;s
            </div>
            ...
            <p className="mt-4 text-center text-neutral-400 text-base md:text-lg font-manrope max-w-2xl mx-auto">
              Running low? Add data, airtime, voice, SMS or WhatsApp bundles in
              seconds. Here&apos;s exactly how it works.
            </p>
            ...
            <div className="rounded-[28px] bg-[#26252C] border border-white/10 p-6 md:p-10">
              ...
              <div className="mt-8 flex items-start gap-3">
                ...
                <p className="text-sm text-[#ABFF63] font-manrope">
                  <span className="font-semibold">Pro tip:</span> If you
                  consistently run low before month-end, consider switching to a
                  subscription. It renews automatically and you can change or
                  cancel anytime.
                </p>
              </div>
            </div>
      ...
      <MobilePage title="How to Top Up" backTo="/how-to">
        <div className="px-4 pt-4 space-y-6">
          ...
          <div className="rounded-2xl bg-[#26252C] border border-white/10 p-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-grotesque font-bold text-xl">Top-up tips</h2>
            </div>
            ...
            <div className="mt-4 flex items-start gap-2">
              ...
              <p className="text-xs text-[#ABFF63] font-manrope">
                <span className="font-semibold">Pro tip:</span> Switch to a
                subscription for automatic monthly renewal.
              </p>
            </div>
          </div>
