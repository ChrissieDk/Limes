...
export default function HowToJoinPage() {
  ...
  return (
    <>
        ...
        <div className="min-h-screen bg-neutral-900 text-white">
          ...
          <section className="mx-auto max-w-6xl px-6 pt-10 pb-6">
            <div className="font-manrope flex items-center justify-center text-sm text-neutral-400">
              <span className="size-1.5 rounded-full bg-yellow-300 mr-2" /> How
              To&apos;s
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="rounded-[28px] bg-yellow-300 text-neutral-900 border-2 border-black/70 shadow-[4px_4px_0_0_rgba(0,0,0,0.7)] p-6 md:p-8">
                ...
                <p className="mt-3 text-[15px] md:text-base text-neutral-900/80 font-manrope leading-relaxed max-w-[52ch]">
                  Start fresh with a Limes number on prepaid or subscription.
                  Choose a subscription that suits you, order online, and
                  we&apos;ll deliver to your door.
                </p>
                <ul className="mt-4 space-y-2 text-sm text-neutral-900/70 font-manrope">
                  <li className="flex items-start gap-2">
                    <img
                      src={`${import.meta.env.BASE_URL}images/plan_icon_small.svg`}
                      alt=""
                      className="h-4 w-5 mt-[2px] object-contain shrink-0"
                    />
              ...
              <div className="rounded-[28px] bg-pink-300 text-neutral-900 border-2 border-black/70 shadow-[4px_4px_0_0_rgba(0,0,0,0.7)] p-6 md:p-8">
                ...
                <p className="mt-3 text-[15px] md:text-base text-neutral-900/80 font-manrope leading-relaxed max-w-[62ch]">
                  Bring your existing number to Limes and enjoy better value on
                  the same number you already use. We handle the breakup with
                  your old network.
                </p>
                <ul className="mt-4 space-y-2 text-sm text-neutral-900/70 font-manrope">
                  <li className="flex items-start gap-2">
                ...
                <p className="mt-3 text-xs md:text-sm text-neutral-900/70 font-manrope max-w-[72ch]">
                  During the handover you may experience limited connectivity
                  for a few minutes. We recommend starting on a weekday morning.
                </p>
                <div className="mt-6">
                  <Link
                    to={ctaPath}
            ...
            <div className="rounded-[28px] bg-[#26252C] border border-white/10 p-6 md:p-10">
              ...
              <div className="mt-8 flex items-start gap-3">
                ...
                <p className="text-sm text-[#ABFF63] font-manrope">
                  <span className="font-semibold">Pro tip:</span> Start your
                  port on a weekday morning for the fastest turnaround. Ports
                  are not processed over the weekend.
                </p>
              </div>
            </div>
          </section>
      ...
      <MobilePage title="How to Join" backTo="/how-to">
        <div className="px-4 pt-4 pb-8">
          ...
          <div className="space-y-3">
            <div className="rounded-2xl bg-yellow-300 text-neutral-900 p-4">
              <img
                src={`${import.meta.env.BASE_URL}images/zblock.svg`}
                alt=""
                className="h-8 w-8"
              />
              <h3 className="mt-3 font-grotesque font-bold text-lg leading-tight">
                Get a new Limes SIM
              </h3>
              <p className="mt-2 text-sm text-neutral-900/75 font-manrope leading-relaxed">
                Start fresh with a Limes number on prepaid or subscription.
                Order online, we deliver to your door.
              </p>
              <ul className="mt-3 space-y-1.5 text-xs text-neutral-900/65 font-manrope">
                <li className="flex items-start gap-2">
                  <img
                    src={`${import.meta.env.BASE_URL}images/plan_icon_small.svg`}
                    alt=""
                    className="h-3.5 w-4 mt-[3px] object-contain shrink-0"
                  />
                  <span>Delivered in 2–5 business days</span>
                </li>
                <li className="flex items-start gap-2">
            ...
            <div className="rounded-2xl bg-pink-300 text-neutral-900 p-4">
              <img
                src={`${import.meta.env.BASE_URL}images/house_small.svg`}
                alt=""
                className="h-8 w-8"
              ...
              <p className="mt-2 text-sm text-neutral-900/75 font-manrope leading-relaxed">
                Bring your existing number to Limes. We handle the breakup with
                your old network.
              </p>
              <ul className="mt-3 space-y-1.5 text-xs text-neutral-900/65 font-manrope">
                <li className="flex items-start gap-2">
          ...
          <div className="mt-8">
            <div className="flex items-center gap-2 mb-4">
              <span className="w-2 h-2 rounded-full bg-[#ABFF63]" />
              <h2 className="font-grotesque font-bold text-lg">
                The full journey
              </h2>
            </div>
            <div className="space-y-3">
              {steps.map((step) => (
                <div
                  key={step.number}
                  className={`rounded-2xl ${step.colour} ${step.textColour} p-4`}
                >
                  <div className="flex items-start gap-3">
                    <div className="font-grotesque font-bold text-[32px] leading-none opacity-30 shrink-0">
                      {step.number}
                    </div>
                    <div>
                      <h3 className="font-grotesque font-bold text-base leading-tight">
                        {step.title}
                      </h3>
                      <p className="mt-1 text-sm text-neutral-900/75 font-manrope leading-relaxed">
                        {step.description}
                      </p>
                    </div>
                  </div>
          ...
          {/* Porting */}
          <div className="mt-8 rounded-2xl bg-[#26252C] border border-white/10 p-4">
            <div className="flex items-center gap-2 mb-4">
              <span className="w-2 h-2 rounded-full bg-pink-300" />
              <h2 className="font-grotesque font-bold text-lg leading-tight">
            ...
            <div className="space-y-4">
              {portingNotes.map((note) => (
                <div key={note.title}>
                  <h3 className="font-grotesque font-bold text-white text-sm">
                    {note.title}
                  </h3>
                  <p className="mt-0.5 text-xs text-neutral-400 font-manrope leading-relaxed">
                    {note.body}
                  </p>
                </div>
              ))}
            ...
            <div className="mt-4 flex items-start gap-2">
              ...
              <p className="text-xs text-[#ABFF63] font-manrope">
                <span className="font-semibold">Pro tip:</span> Start your port
