...
export default function HowItWorks() {
  return (
    <>
        ...
        <div className="min-h-screen bg-neutral-900 text-white">
          ...
          <section className="mx-auto max-w-6xl px-6 pt-10 pb-6">
            <div className="font-manrope flex items-center justify-center text-sm text-neutral-400">
              <span className="size-1.5 rounded-full bg-lime-400 mr-2" /> How It
              Works
            </div>
            ...
            <p className="mt-4 text-center text-neutral-400 text-base md:text-lg font-manrope max-w-2xl mx-auto">
              No store visits. No paperwork marathons. No locked-in
              subscriptions. Just four steps between you and a subscription that
              actually fits.
            </p>
          </section>
      ...
      <MobilePage title="How It Works" backTo="/">
        <div className="px-4 pt-4 pb-4">
          <p className="font-manrope text-sm text-neutral-400 mb-6">
            No store visits. No paperwork marathons. Just four steps to a
            subscription that fits.
          </p>
            ...
            {steps.map((step) => (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-grotesque font-bold text-lg leading-tight">
                      {step.title}
                    </h3>
