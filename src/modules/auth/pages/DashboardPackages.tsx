...
import {
  ...
  PackageCardSkeleton,
} from "../components/dashboard/PackageSkeletonLoaders.tsx";
...
import type { CatalogCategoryNode, CatalogProduct } from "../../../types";
  ...
  const styles: Record<string, { bg: string; hover: string; icon: ReactNode }> =
    {
      data: {
        ...
        icon: (
          <img
            src={`${import.meta.env.BASE_URL}images/plan_data.svg`}
            alt=""
            className="w-14 h-14"
          />
        ),
      ...
      sms: {
        ...
        icon: (
          <img
            src={`${import.meta.env.BASE_URL}images/plan_sms.svg`}
            alt=""
            className="w-14 h-14"
          />
        ),
      ...
      whatsapp: {
        ...
        icon: (
          <img
            src={`${import.meta.env.BASE_URL}images/whatsapp_icon_small.svg`}
            alt=""
            className="w-14 h-14"
          />
        ),
...
function PageHeader({
  ...
  return (
    <>
      ...
      <p className="font-manrope mt-2 text-center text-neutral-400">
        {subtitle}
      </p>
    </>
  );
...
// ── Shared subscription step content (used by both desktop and mobile) ──
...
interface SubscriptionStepsProps {
  ...
  handleIccidSubmit: () => void;
  handleBundleCategorySelect: (id: string) => void;
...
function SubscriptionSteps(props: SubscriptionStepsProps) {
  const {
    packageType,
    simStatus,
    contractFlowType,
  ...
  const comboBundleCount = comboBundles.length;
  ...
  return (
    <>
      ...
      {/* Step 1: Package Type */}
      {!packageType && (
        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 max-w-4xl mx-auto">
          <button
            onClick={() => handlePackageTypeSelect("contract")}
            className="group rounded-[22px] md:rounded-[28px] bg-[#FDDA36] md:shadow-[0_24px_70px_rgba(0,0,0,0.35)] transition-all min-h-[180px] md:min-h-[210px] px-6 py-7 md:px-10 md:py-9 flex flex-col items-center justify-center text-center"
          >
            <img
              src={`${import.meta.env.BASE_URL}images/house.png`}
              alt=""
              className="h-9 w-9 md:h-11 md:w-11 mb-3 md:mb-4"
            />
            <h3 className="font-grotesque text-neutral-900 font-bold text-2xl md:text-[34px] leading-[1.05]">
              Subscription
            </h3>
            <p className="font-manrope mt-1 md:mt-1.5 text-neutral-900/80 text-sm md:text-lg">
              Long-term subscriptions with SIM delivery.
            </p>
            <span className="inline-block mt-3 text-neutral-900 font-semibold text-sm">
          ...
          <button
            ...
            className="group rounded-[22px] md:rounded-[28px] bg-[#ABFF63] md:shadow-[0_24px_70px_rgba(0,0,0,0.35)] transition-all min-h-[180px] md:min-h-[210px] px-6 py-7 md:px-10 md:py-9 flex flex-col items-center justify-center text-center"
          >
            <img
        ...
        <div className="mt-4 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
            <button
              ...
              className="group rounded-[22px] md:rounded-[28px] bg-[#F8A1D9] hover:brightness-95 md:shadow-[0_24px_70px_rgba(0,0,0,0.35)] transition-all min-h-[180px] md:min-h-[210px] px-6 py-7 md:px-10 md:py-9 flex flex-col items-center justify-center text-center"
            >
              <img
                src={`${import.meta.env.BASE_URL}images/house.png`}
                alt=""
              ...
              <p className="font-manrope mt-1 md:mt-1.5 text-neutral-900 text-sm md:text-lg inline-flex items-center gap-2">
            ...
            <button
              ...
              className="group rounded-[22px] md:rounded-[28px] bg-[#629CFC] hover:brightness-95 md:shadow-[0_24px_70px_rgba(0,0,0,0.35)] transition-all min-h-[180px] md:min-h-[210px] px-6 py-7 md:px-10 md:py-9 flex flex-col items-center justify-center text-center"
            >
              <img
                src={`${import.meta.env.BASE_URL}images/zblock.png`}
                alt=""
          ...
          <div className="mt-4 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
              <button
                ...
                className="group rounded-[22px] md:rounded-[28px] bg-[#D8B0FF] hover:brightness-95 md:shadow-[0_24px_70px_rgba(0,0,0,0.35)] transition-all min-h-[180px] md:min-h-[210px] px-6 py-7 md:px-10 md:py-9 flex flex-col items-center justify-center text-center"
              >
                <img
              ...
              <button
                ...
                className="group rounded-[22px] md:rounded-[28px] bg-pink-300 hover:brightness-95 md:shadow-[0_24px_70px_rgba(0,0,0,0.35)] transition-all min-h-[180px] md:min-h-[210px] px-6 py-7 md:px-10 md:py-9 flex flex-col items-center justify-center text-center"
              >
                <img
      ...
      {simStatus === "has-sim" && !iccidConfirmed && (
        <div className="mt-4 max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto">
          <BackButton onClick={handleBackFromIccidInput} />
          <div className="rounded-[22px] md:rounded-[28px] p-6 md:p-10 bg-[#629BFC] md:shadow-[0_24px_70px_rgba(0,0,0,0.35)]">
            ...
            <h3 className="font-grotesque text-neutral-900 font-semibold text-2xl md:text-[40px] mb-2 text-center leading-[1.05]">
              Enter your ICCID
            </h3>
            <p className="font-manrope text-neutral-900/80 text-sm md:text-lg mb-4 md:mb-7 text-center">
              Your ICCID is printed on the back of your SIM card
            </p>
            <div className="bg-white/25 rounded-xl md:rounded-2xl p-4 md:p-6 mb-4 md:mb-7">
              <label
                htmlFor="iccid"
                className="block text-neutral-900 font-semibold mb-2 text-sm"
              >
                ICCID Number
              </label>
              <input
                ...
                className={`w-full px-4 py-3 rounded-xl bg-white text-neutral-900 font-mono text-base md:text-lg border focus:outline-none focus:ring-2 ${iccidError ? "border-red-500 focus:ring-red-400" : "border-black/30 focus:ring-black/30"}`}
                maxLength={22}
              />
              {iccidError ? (
                ...
                <p className="font-manrope text-neutral-900/70 text-xs md:text-sm mt-2">
            ...
            <button
              ...
              className="w-full bg-neutral-900 text-white py-3.5 md:py-4 rounded-xl md:rounded-2xl font-bold text-base md:text-lg hover:bg-neutral-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed md:shadow-[0_18px_55px_rgba(0,0,0,0.25)]"
            >
      ...
      {packageType === "prepaid" &&
        !selectedBundleCategory &&
        !showPackages &&
        (loading || bundleCategories.length > 0) && (
                ...
                {bundleCategories.map((category) => {
                  ...
                  return (
                    <button
                      ...
                      className={`group rounded-[22px] md:rounded-[24px] px-6 py-7 md:px-8 md:py-8 ${style.bg} ${style.hover} transition-all min-h-[160px] md:min-h-[200px] flex flex-col items-center justify-center text-center`}
                    >
                      <div className="mb-3 md:mb-4 text-neutral-900">
                        {style.icon}
                      </div>
                      <h3 className="font-grotesque text-neutral-900 font-bold text-xl md:text-[30px] leading-[1.05]">
                        {category.name}
                      </h3>
                      <div className="font-manrope mt-2 md:mt-3 inline-flex items-center justify-center rounded-full bg-black/35 text-white px-4 py-1 md:py-1.5 text-xs md:text-sm font-semibold">
                        {category.productCount}{" "}
                        {category.productCount === 1 ? "option" : "options"}
                      </div>
                    </button>
                  );
                })}
      ...
      {packageType === "prepaid" && showPackages && selectedBundleCategory && (
        <div className="mt-4">
          <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
            ...
            <button
              onClick={handleReset}
              className="px-4 md:px-6 py-2 md:py-3 rounded-xl bg-neutral-700 text-white font-semibold text-sm hover:bg-neutral-600 transition-colors"
            >
              Start over
            </button>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-8 md:py-12">
              ...
              <button
                onClick={handleBackFromPackages}
                className="px-5 md:px-6 py-2.5 md:py-3 bg-lime-400 text-neutral-900 rounded-xl font-semibold text-sm hover:bg-lime-300 transition-colors"
              >
                Go Back
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6 mb-8 md:mb-12">
              {products.map((pkg, idx) => {
                ...
                return (
                  <div
                    key={pkg.id}
                    className={`rounded-[22px] md:rounded-[28px] p-6 md:p-8 ${colorScheme.bg} md:shadow-[0_24px_70px_rgba(0,0,0,0.35)] transition-all min-h-[200px] md:min-h-[230px] flex flex-col`}
                  >
                    <div className="font-grotesque text-neutral-900 font-bold text-2xl md:text-[34px] leading-[1.05] tracking-tight">
                      {pkg.name}
                    </div>
                    <div className="mt-3 md:mt-4 h-[2px] w-full bg-neutral-900/30" />
                    <div className="font-grotesque mt-4 md:mt-6 text-neutral-900 font-bold text-3xl md:text-[48px] leading-none tracking-tight">
                      R{pkg.price.toFixed(2)}
                    </div>
                    <div className="mt-4 md:mt-6">
                      <button
                        onClick={() => handleBuyNow(pkg)}
                        className="inline-flex items-center justify-center h-10 px-6 rounded-xl md:rounded-[12px] bg-white text-neutral-900 text-sm font-semibold border border-neutral-900/50 hover:bg-neutral-50 transition-colors"
                      >
                        Buy now
                      </button>
                    </div>
            ...
            <div className="text-center py-8 md:py-12 text-neutral-400">
              <p className="font-manrope text-base md:text-lg">
                No subscriptions available in this category.
              </p>
            </div>
          )}
        </div>
...
export default function DashboardPackages() {
  ...
  const stepsProps: SubscriptionStepsProps = {
    packageType,
    simStatus,
    contractFlowType,
    iccidConfirmed,
  ...
  return (
    <>
            ...
            <section className="relative bg-neutral-900">
              ...
              <div className="mx-auto max-w-6xl px-2 sm:px-6 pt-4 sm:pt-6">
                <div className="font-manrope flex items-center justify-center text-sm text-neutral-400">
                  <span className="size-1.5 rounded-full bg-purple-400 mr-2" />{" "}
                  Subscriptions
                </div>
                <PageHeader
                  packageType={packageType}
      ...
      <div className="lg:hidden">
        <MobilePage title="Subscriptions" backTo="/dashboard">
