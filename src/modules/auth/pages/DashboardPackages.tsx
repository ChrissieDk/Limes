                  ...
                  {!packageType && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 max-w-4xl mx-auto">
                      ...
                      >
                        ...
                        <h3 className="font-grotesque text-neutral-900 font-bold text-[30px] md:text-[34px] leading-[1.05]">
                          Subscription
                        </h3>
                        <p className="font-manrope mt-1.5 text-neutral-900/80 text-base md:text-lg">
                  ...
                  {packageType === "contract" && !contractFlowType && (
                    <div className="max-w-4xl mx-auto">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                        <button
                          onClick={() =>
                            handleContractFlowTypeSelect("dynamic")
                          }
                      ...
                      <div className="rounded-[28px] p-7 md:p-10 bg-[#629BFC] shadow-[0_24px_70px_rgba(0,0,0,0.35)]">
                        ...
                        <div className="bg-white/25 rounded-2xl p-5 md:p-6 mb-7">
                          ...
                          {iccidError ? (
                            ...
                            <p className="font-manrope text-neutral-900/70 text-sm mt-2">
                        ...
                        <button
                          ...
                          disabled={
                            iccid.trim().length < 15 || iccidSubmitLoading
                          }
                            ...
                            {bundleCategories.map((category) => {
                              ...
                              return (
                                <button
                                  key={category.id}
                                  onClick={() =>
                                    handleBundleCategorySelect(category.id)
                                  }
