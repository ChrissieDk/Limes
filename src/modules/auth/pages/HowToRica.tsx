    ...
    <div className="min-h-screen bg-neutral-900 text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 pt-10 pb-6">
        <div className="font-manrope flex items-center justify-center text-sm text-neutral-400">
          <span className="size-1.5 rounded-full bg-[#5BA0FF] mr-2" /> How To&apos;s
        </div>
        <h1 className="mt-4 font-grotesque font-bold text-center leading-[1.05]">
          <span className="block text-[36px] sm:text-[48px] md:text-[64px]">How to RICA</span>
        </h1>
        ...
        <div className="rounded-[28px] bg-[#26252C] border border-white/10 p-6 md:p-10">
          ...
          <div className="mt-8 flex items-start gap-3">
            ...
            <p className="text-sm text-[#ABFF63] font-manrope">
              <span className="font-semibold">Pro tip:</span> Complete RICA as soon as you order your SIM.
              Your SIM can&apos;t be activated until RICA is verified, so doing it early saves you a wait later.
            </p>
          </div>
        </div>
