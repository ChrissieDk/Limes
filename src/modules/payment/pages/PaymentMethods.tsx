...
export default function PaymentMethodsPage() {
  ...
  return (
    <>
            ...
            <div className="max-w-4xl mx-auto mt-5 rounded-[28px] bg-neutral-800 p-8 sm:p-10">
              <div className="mb-6">
                ...
                <p className="font-manrope text-neutral-400 text-sm">
                  Cards saved for quick one-click payments. Your card details
                  are securely stored.
                </p>
              </div>
              <SavedCards />
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-3 mt-6">
              <div className="rounded-[26px] bg-neutral-800 p-6">
                <div className="flex items-start gap-3">
                  <div
                    className="grid place-items-center rounded-xl bg-[#ABFF63]/10 shrink-0"
                    style={{ width: 36, height: 36 }}
                  >
                    <Lock className="w-4 h-4 text-[#ABFF63]" />
                  </div>
                  <div>
                    <h3 className="font-grotesque text-sm font-semibold text-white mb-1">
                      Secure &amp; Encrypted
                    </h3>
                    <p className="font-manrope text-sm text-neutral-400">
                      Your card details are never stored directly. We use secure
                      tokens provided by Paystack.
                    </p>
                  </div>
                </div>
              </div>
              <div className="rounded-[26px] bg-neutral-800 p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-manrope text-sm text-neutral-400">
                      Use saved cards for instant payments without re-entering
                      card details.
                    </p>
                  </div>
                </div>
      ...
      <MobilePage title="Payment Methods" backTo="/dashboard">
        <div className="px-4 pt-4 space-y-4 pb-4">
          <div className="rounded-2xl bg-neutral-800 p-4">
            <h2 className="text-white font-grotesque font-semibold text-lg mb-1">
              Your saved cards
            </h2>
            <p className="font-manrope text-neutral-400 text-xs mb-4">
              Cards saved for quick one-click payments. Securely stored.
            </p>
            <SavedCards />
          </div>
          ...
          <div className="space-y-2">
            <div className="rounded-xl bg-neutral-800 p-4">
              <div className="flex items-start gap-3">
                <div
                  className="grid place-items-center rounded-lg bg-[#ABFF63]/10 shrink-0"
                  style={{ width: 32, height: 32 }}
                >
                  <Lock className="w-3.5 h-3.5 text-[#ABFF63]" />
                </div>
                <div>
                  <h3 className="font-grotesque text-sm font-semibold text-white mb-0.5">
                    Secure &amp; Encrypted
                  </h3>
                  <p className="font-manrope text-xs text-neutral-400">
                    Card details never stored directly. Secure tokens via
                    Paystack.
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-xl bg-neutral-800 p-4">
              <div className="flex items-start gap-3">
                <div
                  ...
                  style={{ width: 32, height: 32 }}
                >
                  <Zap className="w-3.5 h-3.5 text-[#ABFF63]" />
                </div>
                <div>
                  <h3 className="font-grotesque text-sm font-semibold text-white mb-0.5">
                    One-click payments
                  ...
                  <p className="font-manrope text-xs text-neutral-400">
                    Instant payments without re-entering card details.
                  </p>
                </div>
              </div>
            </div>
