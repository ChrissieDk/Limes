 ...
 *  - card: #16161C with white/8 border
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background-color:#16161C;border-radius:28px;border:1px solid rgba(255,255,255,0.08);overflow:hidden;">
          ...
          <tr>
            <td style="padding:28px 40px 0 40px;">
              ...
              <p style="margin:0 0 16px 0;font-size:16px;color:#E8E8F0;line-height:1.7;">
                We received a request to reset your password for your Limes account. Click the button below to choose a new password. If you didn't request this, you can safely ignore this email.
              </p>
            </td>
          </tr>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background-color:#ABFF63;border-radius:12px;border:2px solid rgba(0,0,0,0.7);box-shadow:4px 4px 0 0 rgba(0,0,0,0.7);">
                    <a href="${resetLink}" style="display:inline-block;padding:14px 32px;font-size:15px;font-weight:700;color:#000000;text-decoration:none;letter-spacing:-0.01em;">
                      Reset Password
                    </a>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:16px 20px;">
                    <p style="margin:0;font-size:13px;color:#A0A0A8;line-height:1.6;">
                      This link will expire in <strong style="color:#ABFF63;">1 hour</strong>. For your security, never share this link with anyone.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding:32px 40px 36px 40px;">
              ...
              <p style="margin:0;font-size:12px;color:#484850;text-align:center;">
                If you didn't request this reset, contact our support team immediately.
              </p>
            </td>
          </tr>
